...
import '../CSS/App.css'
//import songs
import song1 from '../static/songs/_Ram Siya Ram(PagalWorld.com.se).mp3'
import song2 from '../static/songs/old_Murder-Kaho Na Kaho.mp3';
import song3 from '../static/songs/src_assets_songs_senorita.mp3';
import song4 from '../static/songs/Bhalobashar-Morshum--Duet--Arijit-Singh-Shreya-Ghoshal.mp3';
import song5 from '../static/songs/Haan Tu Hain - Jannat 320Kbps.mp3';
import song6 from '../static/songs/Let-Me-Down-Slowly_320(PagalWorldl).mp3';
import song7 from '../static/songs/Alvida (Life...Metro) - K.K - 320Kbps.mp3'
import song8 from '../static/songs/zamona-net-ed-sheeran-shape-of-you.mp3';
//import songImages
import song1Img from '../static/images/Ram Siya Ram.jpg';
import song2Img from '../static/images/Kaho na Kaho.jpg';
import song3Img from '../static/images/senorita.jpg';
import song4Img from '../static/images/Valobasar.jpg';
import song5Img from '../static/images/Hain Tu.jpeg';
import song6Img from '../static/images/let me down slowly.jpg';
import song7Img from '../static/images/albida.jpg'
import song8Img from '../static/images/shape of you.jpg'
//import wallpaper
import wallpaper1 from '../static/images/wallpaper1.jpg';
import wallpaper2 from '../static/images/wallpaper2.jpg';
import wallpaper3 from '../static/images/wallpaper3 - Copy.jpg';
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      songImgItemsUrl: [song1Img, song2Img, song3Img,song4Img,song5Img,song6Img,song7Img,song8Img],  //song images list
      wallpaperItems: [wallpaper1, wallpaper2, wallpaper3], //wallpapers
      songItems: ["Ram Siya Ram", "Kaho Na Kaho", "senorita","Bhalobashar-Morshum","Haan Tu Hain - Jannat","Let-Me-Down-Slowly","Alvida (Life...Metro) - K.K","shape-of-you-ed-sheeran"], //song names
